    ...
    <div className="flex h-screen flex-col bg-canvas text-ink">
      ...
      <div className="flex min-h-0 flex-1">
        ...
        <main ref={setMainEl} className="min-w-0 flex-1 overflow-auto">
          <div
            className={`grid w-full gap-4 px-3 pt-3 sm:gap-6 sm:px-5 lg:px-6 ${
...
export function ReviewShellSkeleton(props: { label: string }) {
  return (
    ...
    >
      ...
      <div className="grid w-full gap-4 px-3 pt-4 sm:gap-6 sm:px-6 lg:grid-cols-[minmax(0,1fr)_340px] lg:px-10">
