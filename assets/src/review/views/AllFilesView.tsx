...
const StackedFileCardBody = observer(function StackedFileCardBody(props: {
  ...
  const capabilities = viewCapabilities({ kind: viewKind, previewable, image, sourceView, binary })
  ...
  return (
    ...
    >
      <FileRenderHeader
        ...
        added={fileSnapshot.added ?? null}
        deleted={fileSnapshot.deleted ?? null}
            ...
            {image ? (
              ...
              <ReviewViewProvider value={view}>
                <FileScopeProvider
                  ...
                  filePath={path}
                >
                  <ViewComponent view={view} forceSource={sourceView} inline={!railActive} nested />
                </FileScopeProvider>
              </ReviewViewProvider>
            )}
          </div>
