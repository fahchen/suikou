  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex items-center gap-3">
        <span className="grid size-[44px] place-items-center rounded-[12px] bg-accent text-xl font-black text-on-accent">
          推
        </span>
        <div>
          <div className="text-base font-bold text-ink">推敲 Suikou</div>
          <div className="text-xs text-muted">Deliberate review of what an agent wrote.</div>
        </div>
      </div>
