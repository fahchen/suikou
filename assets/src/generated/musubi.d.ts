...
declare namespace Musubi {
  ...
  interface Stores {
    ...
    "SuikouWeb.Stores.CommentsStore": StoreDef<
      ...
      {
        items: Array<{ id: string; scope: "review" | "artifact" | "located"; critique_type: "fix_required" | "needs_answer" | "note"; status: "pending" | "published"; author: { kind: "human" | "agent"; name: string | null; icon: string | null }; body: string; resolved: boolean; resolved_round: number | null; resolved_by: { kind: "human" | "agent"; name: string | null; icon: string | null } | null; outdated: boolean; drifted: boolean; authored_round: number; inserted_at: string; anchor: { type: "line_range"; start_line: number; end_line: number; quote: string } | { type: "diff_hunk"; side: "old" | "new"; start_line: number; end_line: number; quote: string } | { type: "element"; selector: string; quote: string } | null; replies: Array<{ id: string; author: { kind: "human" | "agent"; name: string | null; icon: string | null }; status: "pending" | "published"; body: string; inserted_at: string; reactions: Array<{ emoji: string; actor: "human" | "agent"; count: number; mine: boolean; by: { name: string; icon: string }[] }> }>; reactions: Array<{ emoji: string; actor: "human" | "agent"; count: number; mine: boolean; by: { name: string; icon: string }[] }> }>
      },
      {
        edit_comment: {
          payload: {
    ...
    "SuikouWeb.Stores.ProjectBoardStore": StoreDef<
      ...
      {
        projects: Array<{ id: string; name: string; path: string; respect_gitignore: boolean; emoji: string | null; review_instructions: string | null; reviews: Array<{ id: string; name: string; inserted_at: string; kind: "file_selection" | "git_diff"; selections: string[]; base_ref: string | null; head_ref: string | null; refs_valid: boolean }> }>
    ...
    "SuikouWeb.Stores.SettingsStore": StoreDef<
