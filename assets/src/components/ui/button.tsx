...
const buttonVariants = cva(
  "inline-flex shrink-0 items-center justify-center gap-1.5 rounded-ctrl font-semibold whitespace-nowrap outline-none transition-colors select-none focus-visible:ring-2 focus-visible:ring-accent-edge disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        accent: "bg-accent text-on-accent hover:brightness-[1.06] active:translate-y-px",
