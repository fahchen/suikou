...
import { storeCache, useMusubiRoot, useMusubiSnapshot, useMusubiCommand } from "../musubi";
...
function AllFilesShellHeader(props: {
  ...
  const { reviewId, firstFilePath, allFilesCapabilities, wide, hasAnyDraftVerdict, onSubmitClick, submitPending } = props;
  return (
      ...
      <div className="pointer-events-auto ml-auto flex items-center gap-2">
        ...
        <ButtonGroup className="rounded-lg shadow-[0_0_0_1px_var(--line),var(--elev-1)]">
          <Button
            ...
            disabled={!hasAnyDraftVerdict || submitPending}
