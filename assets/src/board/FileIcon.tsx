...
const MARKDOWN: IconSpec = { Icon: FileText, className: "text-accent" }
const CODE: IconSpec = { Icon: FileCode, className: "text-muted" }
const DATA: IconSpec = { Icon: FileJson, className: "text-amber" }
const IMAGE: IconSpec = { Icon: Image, className: "text-approve" }
