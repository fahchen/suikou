defmodule Suikou.ReviewsFixtures do
  @moduledoc """
  Test fixtures for the Reviews context. Centralized here so test modules share
  ...
  def pending_comment(round_id, attrs \\ %{}) do
    ...
    {:ok, comment} = Reviews.add_comment(attrs)
    comment
  end
  ...
  def published_comment(round_id, attrs \\ %{}, verdict \\ :comment) do
    ...
    {:ok, _review} = Reviews.submit_review(round_id, verdict)
    Suikou.Repo.get!(Suikou.Reviews.Schemas.Comment, comment.id)
  end
end
