defmodule Suikou.Artifacts.Submission do
  @moduledoc """
  ...
  ## Examples
      ...
      Suikou.Artifacts.Submission.submit(%{title: "Draft", content: "hello\\n"})
      #=> {:ok, %{artifact: %Suikou.Schemas.Artifact{}, round: %Suikou.Schemas.Round{number: 1}, bumped: true}}

      Suikou.Artifacts.Submission.submit(%{artifact_id: artifact.id, content: "hello\\n"})
      #=> {:ok, %{bumped: false}}

      Suikou.Artifacts.Submission.submit(%{title: "Draft", content: "   "})
      #=> {:error, :empty_content}
  ...
  defp advance(artifact, latest, content) do
    ...
    Critique.carry_forward(latest, new_round)
