defmodule Suikou.Critique.Discussion do
  ...
  ## Examples
      ...
      Suikou.Critique.Discussion.reply_as_human(comment.id, "noted")
      #=> {:ok, %Suikou.Schemas.Reply{author: :human, body: "noted"}}

      Suikou.Critique.Discussion.reply_as_human("0192c9f4-7e3a-7b3a-8c3a-1a2b3c4d5e6f", "noted")
  ...
  ## Examples
      ...
      Suikou.Critique.Discussion.reply_as_agent(comment.id, "fixed")
      #=> {:ok, %Suikou.Schemas.Reply{author: :agent, body: "fixed"}}

      Suikou.Critique.Discussion.reply_as_agent("0192c9f4-7e3a-7b3a-8c3a-1a2b3c4d5e6f", "fixed")
      #=> {:error, :comment_not_found}
