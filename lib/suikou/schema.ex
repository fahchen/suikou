defmodule Suikou.Schema do
  ...
  primary keys and UUID foreign keys (see RFC 9562). Monotonic precision keeps
  `order_by: :id` equal to insertion order even for sub-millisecond inserts,
  which the reply/comment threads rely on.
