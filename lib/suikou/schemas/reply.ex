defmodule Suikou.Schemas.Reply do
  ...
  ## Examples
      ...
      iex> Suikou.Schemas.Reply.changeset(%{comment_id: "0192c9f4-7e3a-7b3a-8c3a-1a2b3c4d5e6f", author: :human, body: "noted"}).valid?
      true

      iex> Suikou.Schemas.Reply.changeset(%{comment_id: "0192c9f4-7e3a-7b3a-8c3a-1a2b3c4d5e6f", author: :human, body: " "}).valid?
      false
