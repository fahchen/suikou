...
| Agent | An external system that edits the reviewed files on disk and reads structured critique. It authors comments, replies, and reactions under a name it supplies (see BDR-0026), but never submits content, advances a round, or sets a verdict (see BDR-0018). Not part of the Suikou runtime. |
...
| Resolved | A published comment marked addressed, recording the round (`resolved_round`) and who claimed it — the human or a named agent (see BDR-0026). A claim about the work, not a verdict on it: the human reopens anything they disagree with. |
